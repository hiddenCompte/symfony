...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'agreeTerms' => [parent::class, 'agreeTerms', null, 16],
        "\0".parent::class."\0".'date_inscription' => [parent::class, 'date_inscription', null, 16],
        ...
        "\0".parent::class."\0".'type_utilisateur' => [parent::class, 'type_utilisateur', null, 16],
        'agreeTerms' => [parent::class, 'agreeTerms', null, 16],
        'date_inscription' => [parent::class, 'date_inscription', null, 16],
        ...
        'type_utilisateur' => [parent::class, 'type_utilisateur', null, 16],
    ];
